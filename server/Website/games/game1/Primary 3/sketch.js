...
// levels array
var range_of_numbers_by_level = [2000, 4000, 6000, 8000, 10000];
...
function preload()
{
    ...
    bgm = loadSound("games/game1/Primary 3/sound/Cuckoo Clock Quincas Moreira Background Music Children'sMusic.mp3");
    bgm.setVolume(0.2);
...
function setup()
{
	...
	canvasContainer = select('#game1p3');
    ...
    player = new CharacterGenerator("games/game1/Primary 3/assets/player1.png", "games/game1/Primary 3/assets/player_fish.png",100, 2*height/5-40);
    ai_character = new CharacterGenerator("games/game1/Primary 3/assets/ai_fisherman.png", "games/game1/Primary 3/assets/ai_fish.png",width-150, 2*height/5-40);

    startpage_background = loadImage("games/game1/Primary 3/assets/beach_mainpage.png");

    scenery = new SceneryGenerator(0, height/5, width, 4*height/5);

    // Start Button
    game_start_button = createImg('games/game1/Primary 3/assets/start-button.png');  
    game_start_button.parent("game1p3");
